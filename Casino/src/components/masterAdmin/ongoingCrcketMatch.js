...
class MasterAdminCricket extends Component{
    constructor(props){
        super(props)
        this.state={
            pageCount:'',
    ...
    handlePageClick = (data) => {
      ...
      handleUpdate =(e,id)=>{
          window.location = `/MasterAdminCricketMatch/${id}`
      }
...
<Sidebar />
             ...
             <h2 style={{"overflow-x":"auto","color":"#5eb9f5"}} >Cricket Market </h2>
...
export default MasterAdminCricket;