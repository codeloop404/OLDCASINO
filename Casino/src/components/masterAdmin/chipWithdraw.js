...
class ChipWithdrawMaster extends Component{
	constructor(props){
		super(props)
		this.state = {
			userName:'',
     ...
     async getAccountDetail(){
        ...
        axios.defaults.headers.common['masterAdmintoken'] = token;
        var id = this.props.match.params.Id
        axios.get(`${SERVER}/getWithdrawTransactionByUser`,{id:id}).then((response)=>{
    ...
    render(){
        ...
        return(
           ...
           <div class="row">
               ...
               <h2 style={{"overflow-x":"auto","color":"#5fb9f5",    marginLeft: "35%",fontSize:"22px"}} >Chip Withdraw History</h2>
            ...
            <div style={{"overflow-x":"auto","color":"white"}} >
               <table style={{width: '100%'}}>
                   {/* All MAsters */}
                            ...
                            <td style={{color:"red"}}>&#x20b9;{contact.amount}</td>
...
export default ChipWithdrawMaster;