...
class MasterAdminLiveCasino extends Component{
    constructor(props){
        super(props)
        this.state={
            transaction:[],
        ...
        return(
           ...
           <div class="row">
             ...
             <div className="table-responsive" >
                        <h2 style={{"overflow-x":"auto","color":"#5eb9f5",    marginLeft: "35%",fontSize:"22px"}}>Participants</h2>
...
export default MasterAdminLiveCasino;