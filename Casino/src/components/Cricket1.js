...
class Cricket1 extends Component {
    socket = {};
    ...
    async getUser() {
        ...
        console.log("============yyyyyyyy=6780199999999999999999$$$$$$$$$$$$$$$$$$5r24e2732========llllllllllll=", response.data.user.walletBalance)
...
if(this.state.selectedBet == "Session"){
    this.setState({profit:parseInt(this.state.calculatoClick+0)})
}    
if(this.state.betSelected == this.state.match.matchWinTeam1){
this.setState({profit:(this.state.match.matchWinTeam1/100)*parseInt(this.state.calculatoClick+0)})
}    
if(this.state.betSelected == this.state.match.matchWinTeam2){
    console.log(this.state.calculatoClick+0,this.state.betAmount,"=====hojojoooooooo000000")

    this.setState({profit:parseInt(this.state.calculatoClick+0),betAmount:(this.state.match.matchWinTeam2/100)*parseInt(this.state.calculatoClick+0)})
    }
    ...
    handleClick1 =()=>{
        ...
        if(this.state.selectedBet == "Session"){
            ...
            this.setState({profit:parseInt(this.state.calculatoClick+1)})
        } 
        if(this.state.betSelected == this.state.match.matchWinTeam1){
            this.setState({profit:(this.state.match.matchWinTeam1/100)*parseInt(this.state.calculatoClick+1)})
            }    
            if(this.state.betSelected == this.state.match.matchWinTeam2){
                console.log(this.state.calculatoClick+0,this.state.betAmount,"=====hojojoooooooo000000")

                this.setState({profit:parseInt(this.state.calculatoClick+1),
                    betAmount:(this.state.match.matchWinTeam2/100)*parseInt(this.state.calculatoClick+1)})
                }
    }
    handleClick2 =()=>{
        ...
        if(this.state.selectedBet == "Session"){
            ...
            this.setState({profit:parseInt(this.state.calculatoClick+2)})
        } 
        if(this.state.betSelected == this.state.match.matchWinTeam1){
            this.setState({profit:(this.state.match.matchWinTeam1/100)*parseInt(this.state.calculatoClick+2)})
            }    
            if(this.state.betSelected == this.state.match.matchWinTeam2){
                this.setState({
                    profit:parseInt(this.state.calculatoClick+2),
                    betAmount:(this.state.match.matchWinTeam2/100)*parseInt(this.state.calculatoClick+2)
                })
                }
    }
    handleClick3 =async()=>{
       ...
       if(this.state.selectedBet == "Session"){
        ...
        this.setState({profit:parseInt(this.state.calculatoClick+3)})
    } 
    if(this.state.betSelected == this.state.match.matchWinTeam1){
        this.setState({profit:(this.state.match.matchWinTeam1/100)*parseInt(this.state.calculatoClick+3)})
        }    
        if(this.state.betSelected == this.state.match.matchWinTeam2){
            this.setState({profit:parseInt(this.state.calculatoClick+3),
                betAmount:(this.state.match.matchWinTeam2/100)*parseInt(this.state.calculatoClick+3)})
            }
    }
    handleClick4 = () => {
        ...
        if(this.state.selectedBet == "Session"){
            console.log("======isme ghus raha======")
            this.setState({profit:parseInt(this.state.calculatoClick+4)})
        } 
        if(this.state.betSelected == this.state.match.matchWinTeam1){
            this.setState({profit:(this.state.match.matchWinTeam1/100)*parseInt(this.state.calculatoClick+4)})
            }    
            if(this.state.betSelected == this.state.match.matchWinTeam2){
                this.setState({profit:parseInt(this.state.calculatoClick+4),
                    betAmount:(this.state.match.matchWinTeam2/100)*parseInt(this.state.calculatoClick+4)})
                }
    }
    handleClick5 = () => {
        ...
        if(this.state.selectedBet == "Session"){
            ...
            this.setState({profit:parseInt(this.state.calculatoClick+5)})
        } 
        if(this.state.betSelected == this.state.match.matchWinTeam1){
            this.setState({profit:(this.state.match.matchWinTeam1/100)*parseInt(this.state.calculatoClick+5)})
            }    
            if(this.state.betSelected == this.state.match.matchWinTeam2){
                console.log(this.state.calculatoClick+0,this.state.betAmount,"=====hojojo9990000099ooooooo000000")

                this.setState({profit:parseInt(this.state.calculatoClick+5),  betAmount:(this.state.match.matchWinTeam2/100)*parseInt(this.state.calculatoClick+5)})
                }
    }
    handleClick6 = () => {
        ...
        if(this.state.selectedBet == "Session"){
            ...
            this.setState({profit:parseInt(this.state.calculatoClick+6)})
        } 
        if(this.state.betSelected == this.state.match.matchWinTeam1){
            this.setState({profit:(this.state.match.matchWinTeam1/100)*parseInt(this.state.calculatoClick+6)})
            }    
            if(this.state.betSelected == this.state.match.matchWinTeam2){
                this.setState({profit:parseInt(this.state.calculatoClick+6),  betAmount:(this.state.match.matchWinTeam2/100)*parseInt(this.state.calculatoClick+6)})
                }
    }
    handleClick7 = () => {
        ...
        if(this.state.selectedBet == "Session"){
            ...
            this.setState({profit:parseInt(this.state.calculatoClick+7)})
        } 
        if(this.state.betSelected == this.state.match.matchWinTeam1){
            this.setState({profit:(this.state.match.matchWinTeam1/100)*parseInt(this.state.calculatoClick+7)})
            }    
            if(this.state.betSelected == this.state.match.matchWinTeam2){
                this.setState({profit:parseInt(this.state.calculatoClick+7),  betAmount:(this.state.match.matchWinTeam2/100)*parseInt(this.state.calculatoClick+7)})
                }
    }
    handleClick8 = () => {
        ...
        if(this.state.selectedBet == "Session"){
            ...
            this.setState({profit:parseInt(this.state.calculatoClick+8)})
        } 
        if(this.state.betSelected == this.state.match.matchWinTeam1){
            this.setState({profit:(this.state.match.matchWinTeam1/100)*parseInt(this.state.calculatoClick+8)})
            }    
            if(this.state.betSelected == this.state.match.matchWinTeam2){
                this.setState({profit:parseInt(this.state.calculatoClick+8),  betAmount:(this.state.match.matchWinTeam2/100)*parseInt(this.state.calculatoClick+8)})
                }
    }
    handleClick9 = () => {
        ...
        if(this.state.selectedBet == "Session"){
            ...
            this.setState({profit:parseInt(this.state.calculatoClick+9)})
        } 
        if(this.state.betSelected == this.state.match.matchWinTeam1){
            this.setState({profit:(this.state.match.matchWinTeam1/100)*parseInt(this.state.calculatoClick+9)})
            }    
            if(this.state.betSelected == this.state.match.matchWinTeam2){
                this.setState({profit:parseInt(this.state.calculatoClick+8),  betAmount:(this.state.match.matchWinTeam2/100)*parseInt(this.state.calculatoClick+9)})
                }
    }
...
console.log("==============",this.state.betName)
        ...
        if (parseInt(this.state.betAmount) > this.state.walletBalance) {

            toast(`Insufficient Balance Please Refill Account`, { containerId: 'B' })
            return
        }
        // if (this.state.currentServerTime < this.state.match.betExpiredAt){

        //     toast(`Game Time Over`, { containerId: 'B' })
        //     return
        // }
        ...
        if (this.state.betName === "2 Over No") {
            ...
            if (this.state.betSelected !== this.state.match.twoOverSession.no) {
                ...
                const token = localStorage.getItem('usertoken')
                axios.defaults.headers.common['Authorization'] = token;
                axios.post(`${SERVER}/betPlaceon2overNo`, { id: this.state.match._id, masterAdmin: this.state.masterAdmin, masterAdminComission: parseFloat(this.state.masterAdminComission), betAmount: parseInt(this.state.betAmount),createdAt:new Date().toISOString().slice(0,10) }).then((response) => {
        ...
        if (this.state.betName === "2 Over Yes") {
            ...
            if (this.state.betSelected !== this.state.match.twoOverSession.yes) {
                ...
                console.log("=============999999999=====99999999====", )

                const token = localStorage.getItem('usertoken')
                axios.defaults.headers.common['Authorization'] = token;
                axios.post(`${SERVER}/betPlaceon2overyes`, { id: this.state.match._id, masterAdmin: this.state.masterAdmin, masterAdminComission: parseFloat(this.state.masterAdminComission), betAmount: parseInt(this.state.betAmount),createdAt:new Date().toISOString().slice(0,10) }).then((response) => {
                    console.log("=============999999999=========", response)
                    toast(response.data.message, { containerId: 'B' })
                    this.setState({
        ...
        if (this.state.betName === "6 Over Yes") {
            ...
            if (this.state.betSelected !== this.state.match.sixOverSession.yes) {
                ...
                axios.post(`${SERVER}/betPlaceon6overYes`, { id: this.state.match._id, masterAdmin: this.state.masterAdmin, masterAdminComission: parseFloat(this.state.masterAdminComission), betAmount: parseInt(this.state.betAmount),createdAt:new Date().toISOString().slice(0,10) }).then((response) => {
                    console.log("=============999999999=========", response)
                    toast(response.data.message, { containerId: 'B' })
                    this.setState({
        ...
        if (this.state.betName === "6 Over No") {
            ...
            if (this.state.betSelected !== this.state.match.sixOverSession.no) {
                ...
                axios.post(`${SERVER}/betPlaceon6overNo`, { id: this.state.match._id, masterAdmin: this.state.masterAdmin, masterAdminComission: parseFloat(this.state.masterAdminComission), betAmount: parseInt(this.state.betAmount),createdAt:new Date().toISOString().slice(0,10) }).then((response) => {
                    console.log("=============999999999=========", response)
                    toast(response.data.message, { containerId: 'B' })
                    this.setState({
        ...
        if (this.state.betName === "10 Over No") {
            ...
            if (this.state.betSelected !== this.state.match.tenOverSession.no) {
                ...
                axios.post(`${SERVER}/betPlaceon10overNo`, { id: this.state.match._id, masterAdmin: this.state.masterAdmin, masterAdminComission: parseFloat(this.state.masterAdminComission), betAmount: parseInt(this.state.betAmount),createdAt:new Date().toISOString().slice(0,10) }).then((response) => {
                    console.log("=============999999999=========", response)
                    toast(response.data.message, { containerId: 'B' })
                    this.setState({
            ...
            toast(`you Have selcted bet of 10 over No`, { containerId: 'B' })
        ...
        if (this.state.betName === "10 Over Yes") {
            ...
            if (this.state.betSelected !== this.state.match.tenOverSession.yes) {
                ...
                axios.post(`${SERVER}/betPlaceon10overYes`, { id: this.state.match._id, masterAdmin: this.state.masterAdmin, masterAdminComission: parseFloat(this.state.masterAdminComission), betAmount: parseInt(this.state.betAmount),createdAt:new Date().toISOString().slice(0,10) }).then((response) => {
                    console.log("=============999999999=========", response)
                    toast(response.data.message, { containerId: 'B' })
                    this.setState({
            ...
            toast(`you Have selcted bet of 10 over Yes`, { containerId: 'B' })
        ...
        if (this.state.betName === "20 Over No") {
            ...
            if (this.state.betSelected !== this.state.match.twentyOverSession.no) {
                ...
                axios.post(`${SERVER}/betPlaceon20overNo`, { id: this.state.match._id, masterAdmin: this.state.masterAdmin, masterAdminComission: parseFloat(this.state.masterAdminComission), betAmount: parseInt(this.state.betAmount) ,createdAt:new Date().toISOString().slice(0,10)}).then((response) => {
                    console.log("=============999999999=========", response)
                    toast(response.data.message, { containerId: 'B' })
                    this.setState({
            ...
            toast(`you Have selcted bet of 20 over No`, { containerId: 'B' })
        ...
        if (this.state.betName === "20 Over Yes") {
            ...
            if (this.state.betSelected !== this.state.match.twentyOverSession.yes) {
                ...
                axios.post(`${SERVER}/betPlaceon20overYes`, { id: this.state.match._id, masterAdmin: this.state.masterAdmin, masterAdminComission: parseFloat(this.state.masterAdminComission), betAmount: parseInt(this.state.betAmount) ,createdAt:new Date().toISOString().slice(0,10)}).then((response) => {
                    console.log("=============999999999=========", response)
                    toast(response.data.message, { containerId: 'B' })
                    this.setState({
            ...
            toast(`you Have selcted bet of 20 over Yes`, { containerId: 'B' })
        ...
        if (this.state.betName == this.state.match.team1) {
            if (this.state.betSelected !== this.state.match.matchWinTeam1) {
                ...
                axios.post(`${SERVER}/betPlaceonTeam1`, { id: this.state.match._id, masterAdmin: this.state.masterAdmin, masterAdminComission: parseFloat(this.state.masterAdminComission), betAmount: parseInt(this.state.betAmount) ,winAmount:parseInt(this.state.profit)+parseInt(this.state.betAmount),createdAt:new Date().toISOString().slice(0,10)}).then((response) => {
                    console.log("=============999999999=========", response)
                    toast(response.data.message, { containerId: 'B' })
                    this.setState({
        ...
        if (this.state.betName == this.state.match.team2) {
            if (this.state.betSelected !== this.state.match.matchWinTeam2) {
                ...
                axios.post(`${SERVER}/betPlaceonTeam2`, { id: this.state.match._id, masterAdmin: this.state.masterAdmin, masterAdminComission: parseFloat(this.state.masterAdminComission), betAmount: parseInt(this.state.betAmount),winAmount:parseInt(this.state.profit)+parseInt(this.state.betAmount) ,createdAt:new Date().toISOString().slice(0,10)}).then((response) => {
                    console.log("=============999999999=========", response)
                    toast(response.data.message, { containerId: 'B' })
                    this.setState({
    ...
    render() {
        console.log("=========9999999===============",this.state.walletBalance)
        if (this.state.load) {
            return (
        ...
        console.log("=========9999999======33333333333=========",this.state.walletBalance)
            ...
            <body className="cricketBack" style={{ background: "#070f29" }}>
                ...
                <div className="cricket_card cricket_card_background content-desktop ">
                    <div style={{height:"70px"}} className="panel-heading">
                        <p className="cricket_header_panel">Wallet Balance:{this.state.walletBalance} <span style={{ marginLeft: "20px", marginRight: "20px" }}>|</span> {this.state.match.matchScoreRun}/{this.state.match.matchWicket} ({this.state.match.runningOvers}.{this.state.match.runningBall})</p>
                    </div>
                    ...
                    <div className="card cricket_secondCard">
                        ...
                        <span class="container1">
                            ...
                            {this.state.match.disabled ?   ( <p className="cricket-input-card6">Ball Running</p>) :(null)}
        ...
        <span className="cricket-input-card5">{this.state.match.matchWinTeam1}</span>
                            ...
                            <div className="card cricket_secondCard2">
                                ...
                                <div className="container1">
                                    <div className="cricket_margin_top">
                                        ...
                                        {this.state.match.disabled ? (<button class="cricket_final_button1" >WAIT</button>
                                        ) : (<button onClick={this.submitBet} class="cricket_final_button1" >OK</button>)}
                ...
                <div className="and_cricket_card cricket_card_background content-mobile">
                    <div className="panel-heading">
                        <p className="and_cricket_header_panel">Wallet Balance:{this.state.walletBalance} <span style={{ marginLeft: "20px", marginRight: "20px" }}>|</span> {this.state.match.matchScoreRun}/{this.state.match.matchWicket} ({this.state.match.runningOvers}.{this.state.match.runningBall})</p>
                    </div>
                    ...
                    <span className="and_width_640px">
                        <div className="card and_cricket_secondCard1">
                            <div className="row">
                                ...
                                <div className="col-md-4 col-sm-4 col-xs-4">
                                    {this.state.match.disabled ? (<span><img className="and_thirdRunningBall" src="../images/runningBall.png"></img></span>):(null)}
                        ...
                        <div className="card and_cricket_secondCard2">
                            <div className="row">
                                ...
                                <div className="col-md-6 col-sm-6 col-xs-6 and_padding_left">
                                    ...
                                    <input type="number" className="and_cricket-input-card6" value={(this.state.profit).toFixed(2)}></input>
                                ...
                                <div className="col-md-3 col-sm-3 col-xs-3 and_cancel_padding_left">
                                    <div className="container1">
                                        ...
                                        <div className="cricket_margin_top">
                                        {this.state.match.disabled ? (<button class="and_cricket_final_button1" >NOT</button>
