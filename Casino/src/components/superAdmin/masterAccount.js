...
class MasertAccount extends Component{
	constructor(props){
		super(props)
		this.state = {
			userName:'',
     ...
     async getAccountDetail(){
        ...
        axios.get(`${SERVER}/getAccountDetailofClient`,{limit:5,offset:this.state.offset,search:this.state.search,}).then((response)=>{
            console.log("=========999999990000006666yyyyyyyyyy===========",response)
    ...
    render(){
        ...
        return(
           ...
           <div class="row">
               ...
               <h2 style={{"overflow-x":"auto","color":"#5fb9f5",    marginLeft: "35%",fontSize:"22px"}} >Account Detail of Client</h2>
