...
class SuperAdminUserList extends Component{
	constructor(props){
		super(props)
		this.state = {
			userName:null,
    ...
    componentDidMount(){
        ...
        axios.get(`${SERVER}/getAllUsers`).then((response)=>{
    ...
    render(){
        ...
        return(
            ...
            <p style={{"overflow-x":"auto","color":"#5fb9f5",    marginLeft: "35%",fontSize:"22px"}} >User List</p>
