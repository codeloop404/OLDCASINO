...
class CricketTransaction extends Component{
	constructor(props){
		super(props)
		this.state = {
			userName:'',
     ...
     async getAccountDetail(){
        ...
        axios.post(`${SERVER}/getCricketTransactionByAccount`,{id:id}).then((response)=>{
    ...
    render(){
        ...
        return(
           ...
           <div class="row">
               ...
               <h2 style={{"overflow-x":"auto","color":"#5fb9f5",    marginLeft: "35%",fontSize:"22px"}} >All Cricket Transaction</h2>
...
export default CricketTransaction;